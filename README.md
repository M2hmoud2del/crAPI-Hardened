...
Welcome to **crAPI-Hardened**! This is a hardened fork of the intentionally vulnerable OWASP crAPI.

Vulnerabilities will be gradually fixed over time. Community testing and responsible disclosure are highly encouraged.

## 🛡️ Security Resources
- **[SECURITY.md](SECURITY.md)**: How to report a vulnerability.
- **[HALL_OF_FAME.md](HALL_OF_FAME.md)**: Recognition for security researchers.
- **[Releases](https://github.com/M2hmoud2del/crAPI-Hardened/releases)**: View the latest fixes and versions.
...
You can use prebuilt images generated by our CI workflow by downloading the docker compose and **.env** files.
 ...
 - To use the latest stable version.
      ...
      ```
      curl -L -o /tmp/crapi.zip https://github.com/M2hmoud2del/crAPI-Hardened/archive/refs/heads/main.zip
      unzip /tmp/crapi.zip
      cd crAPI-Hardened-main/deploy/docker
      docker compose pull
      ...
      ```
      curl.exe -L -o crapi.zip https://github.com/M2hmoud2del/crAPI-Hardened/archive/refs/heads/main.zip
      tar -xf .\crapi.zip
      cd crAPI-Hardened-main/deploy/docker
      docker compose pull
      docker compose -f docker-compose.yml --compatibility up -d
  ...
  - To use the latest development version
      ...
      ```
      curl -L -o /tmp/crapi.zip https://github.com/M2hmoud2del/crAPI-Hardened/archive/refs/heads/develop.zip
      unzip /tmp/crapi.zip 
      ...
      ```
      curl.exe -L -o crapi.zip https://github.com/M2hmoud2del/crAPI-Hardened/archive/refs/heads/develop.zip
      tar -xf .\crapi.zip
      cd crAPI-develop/deploy/docker
      docker compose pull
      docker compose -f docker-compose.yml --compatibility up -d
...
If you need any help with installing and running crAPI you can check out this guide: [Troubleshooting guide crAPI](https://github.com/M2hmoud2del/crAPI-Hardened/blob/main/docs/troubleshooting.md). If this doesn't solve your problem, please create an issue in Github Issues.
